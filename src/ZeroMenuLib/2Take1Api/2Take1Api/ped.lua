...
function ped:create_ped(type,model,pos,headinvalueg,isNetworked,unk1)end
...
function ped:set_ped_head_blend_data(ped,shape_first,shape_second,shape_third,skinvalue_first,skinvalue_second,skinvalue_third,mix_shape,mix_skinvalue,mix_third)end
