...
function graphics:set_checkpoint_icon_height(checkpoinvaluet,height)end
function graphics:set_checkpoint_cylinder_height(checkpoinvaluet,nearHeight,farHeight,radius)end
function graphics:set_checkpoint_rgba(checkpoinvaluet,r,g,b,a)end
function graphics:set_checkpoint_icon_rgba(checkpoinvaluet,r,g,b,a)end
